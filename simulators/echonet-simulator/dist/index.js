...
const EchonetLiteServer_1 = require("./core/EchonetLiteServer");
const EVCharger_1 = require("./classes/EVCharger");
class Simulator {
    constructor() {
        this.devices = new Map();
        this.server = new EchonetLiteServer_1.EchonetLiteServer(3610, '0.0.0.0');
        this.initializeDevices();
    }
    initializeDevices() {
        // EV Charger (0x02A1) instance 1
        const evCharger1 = new EVCharger_1.EVCharger('0x02A1', 1, 'EV Charger 1');
    ...
    handleGetResponse(frame) {
        console.log('Received Get_Res:', frame);
    }
    handleSetResponse(frame) {
